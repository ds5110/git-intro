...
* Use Make
  ...
  * There are many tools for automating workflows. They're typically proprietary and/or harder to use. For automated workflows, I recommend [Github Actions](https://docs.github.com/en/actions).
* Acknowledge
