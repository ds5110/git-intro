...
Recommendations below assume that you're using Linux, macOS (which is basically Linux under the hood) or WSL (not Windows).

For Windows users, I highly recommend that you set up 
